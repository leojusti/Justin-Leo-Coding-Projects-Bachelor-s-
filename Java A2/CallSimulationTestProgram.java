/**
 * Created by justinleo on 2017-01-28.
 */
public class CallSimulationTestProgram {
    ...
    public static void main(String args[]) {
        ...
        // This line now assumes that Tim's call was cut off after 8 minutes, // because his plan only allows 8 more minutes.
        tim.phone(sue, 8);
        ...
        rob.accessInternet(45600);
        rita.accessInternet(2700000);
        rob.accessInternet(1200000);
        tim.accessInternet(10000);
        sue.accessInternet(2500000);
        april.accessInternet(1900000);
